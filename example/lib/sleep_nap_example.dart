...
/// 睡眠阶段+nap图表卡片
class SleepNapChartCard extends StatefulWidget {
  const SleepNapChartCard({super.key});

  @override
  State<SleepNapChartCard> createState() => _SleepNapChartCardState();
}

/// 睡眠阶段+nap图表卡片状态管理类
class _SleepNapChartCardState extends State<SleepNapChartCard> {
  /// 生成示例睡眠数据
